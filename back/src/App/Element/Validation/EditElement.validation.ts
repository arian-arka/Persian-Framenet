...
import {EditElementInterface} from "../Element.interface";
import {ELEMENT_TYPE} from "../Element.contant";

export default class EditElementValidation extends Validation<EditElementInterface> {
    rules(): JSONSchemaType<EditElementInterface> {
        return {
            type: "object",
    ...
    custom(): Function {
        return async (data: EditElementInterface) => {
